<template>
    <div>
        <div class="navTop">
            ...
            <span class="sendQqNum">QQ号码</span>
            <i class="sendIcon" v-on:click="sendQq()">发送</i>
        </div>
        <div class="comment">
            <textarea type="text" placeholder="请填写您的QQ号..." name="text"
                ref="qq"
                value=""
                id="qq"></textarea>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateQq(id, qq) {
                this.$http.post(this.updateBarUrl, {id: id, qq: qq}).then((response) => {
...
.navTop .sendQqNum { display: inline-block; width: 70%; text-align: center; font-size: 0.18rem; color: #fff; }
