    ...
    export default {
        ...
        methods: {
            ...
            updateEndDate(id, endDate) {
                this.$http.post(this.updateBarUrl, {id: id, endtime: endDate}).then((response) => {
...
.navTop .sendEndDate { display: inline-block; width: 70%; text-align: center; font-size: 0.18rem; color: #fff; }
