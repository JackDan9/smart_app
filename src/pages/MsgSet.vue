...
<style scoped>
.pt45{ padding-top:0.65rem; overflow:hidden; padding-top: 0.45rem;}
.ask{ overflow:hidden; }
.w60{border-radius: 0.8rem;width: 0.8rem;height: 0.8rem;}
.mint-cell-title{line-height:50px;}
.cell_right{font-size:20px;}
.cell_ft {text-align: right;color: #888;margin-right:40px;float:right;width:250px;}
...
.mint-cell-value{margin-right:0.2rem}
.mint-switch-input:checked + .mint-switch-core{border-color: #fa550f;background-color: #fa550f;}
</style>
