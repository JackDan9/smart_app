<template>
  <div>
    ...
    <div class="film-list" v-infinite-scroll="loadMore" infinite-scroll-disabled="isLoading" infinite-scroll-distance="10">
...
export default {
 ...
 methods: {
    ...
    getData() {
     this.$http.post(this.videoUrl,{category:this.category,type:this.type}).then( (response) => {
...
.film-list{ overflow-y:auto; background:#141414; overflow-x:hidden; min-height:100vh;}
.film-list .list{ display:-webkit-flex; flex-wrap:wrap; justify-content:flex-start; }
.film-list .box{ width:28%; margin-top:5%; margin-left:4%;  }
