...
.user-index .top .opr {
  ...
  right: 0.2rem;
  top: 0.3rem;
  background: url("~@/assets/images/opr.png") center center no-repeat;
  background-size: cover;
}
.user-index .top .photo {
  width: 0.8rem;
  height: 1rem;
  overflow: hidden;
  margin: auto;
...
.user-index .top .photo .img {
  width: 0.7rem;
  height: 0.7rem;
  overflow: hidden;
  border-radius: 0.7rem;
}
.user-index .top .photo .img .header-img {
  width: 100%;
  height: 100%;
}
.icon-male {
...
.user-index .list li .p1 img {
  width: 0.2rem;
}
.user-index .list li .p2 {
  text-align: center;
}
</style>
