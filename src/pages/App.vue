    ...
    <div>
        <div class="page-topnav">
            <div class="company-top-nav">
                <div class="right-btn">
                    <router-link :to="{path:'/search/1/',query:{tab:'hide'}}" class="iconfont ico sea">&#xe603;</router-link>
                    ...
                    <template v-for="charity in charitys">
                        <li>
                            <a v-on:click="charityClick(charity.id)">
                                <div class="pic">
                                    <img v-if="charity['picture']" :src="fullUrl(charity['picture'])+'!640.340'" class="w100" alt="智慧信阳app欢迎您!">
                                        <div class="operation">
                                            <div class="btn"></div>
...
<style scoped>
/* 导航栏 */
.company-top-nav{ -webkit-transform:translateZ(0); z-index:123456; position:fixed; left:0; top:0; width:100%; height:0.45rem; overflow:hidden;}
.company-top-nav .right-btn{ position:absolute; right:0.08rem; top:0; width:0.8rem; height:0.45rem; line-height: 0.45rem; text-align: center; }
.company-top-nav .right-btn a{ position:relative; float:left; display:block; width:0.35rem; height:0.45rem; }
.company-top-nav .right-btn .sea { color: #fff; }
.company-top-nav .right-btn .user { color: #fff; }
...
.headline .txt{ display:inline-block; vertical-align:middle; line-height:0.24rem; width:65%; overflow:hidden; white-space:nowrap; text-overflow:ellipsis; font-size:0.15rem; margin-left:0.1rem; }
.headline .num{  width:0.22rem; height:0.22rem;display:inline-block; vertical-align:middle; background:#f45633; border-radius:0.22rem;
    text-align:center; line-height:0.22rem; color:#ffffff;}
...
/* 菜单栏 */
.column{ display: block; width: 98%; height: 0.8rem; overflow:hidden; padding: 1%; background: #fff; }
.column a{ display: none; }
.column .filmTv { display: inline-block; width: 37%; height: 0.7rem; background: url("../assets/images/app/column/filmTv.png") center no-repeat; background-size: 100% 100%; }
.column .productList { display: inline-block; width: 37%; height: 0.7rem;  background: url("../assets/images/app/column/productList.png") center no-repeat; background-size: 100% 100%; }
.column .checkMore { display: inline-block; width: 22.6%; height: 0.7rem;  background: url("../assets/images/app/column/checkMore.png") center no-repeat; background-size: 100% 100%; }
/* 热门新闻 */
.hotNew{ overflow:hidden; background:#ffffff;}
/* 标题栏 */
.hotNew .index-box-t{ height:0.4rem; line-height:0.4rem; overflow:hidden; }
.hotNew .index-box-t .left { display: inline-block; width: 64%; height: 0.3rem; margin-left: 0.1rem; border: 1px solid #000; border-radius: 3px; line-height: 0.3rem; text-align: center; font-size: 0;  }
.titleOne { display: inline-block; width: 37%; height: 0.3rem; line-height: 0.3rem; font-size: 0.14rem; font-weight: bold;  }
.titleTwo { display: inline-block; width: 62.8%; height: 0.3rem; line-height: 0.3rem; font-size: 0.14rem; color: #fff; background: #000;  }
.hotNew .index-box-t .right { display: inline-block; width: 28%; height: 0.3rem; line-height: 0.3rem0; text-align: right; }
.newMore { display: inline-block; font-weight: bold; font-size: 9; font-size: 0.14rem; letter-spacing: 0.005rem; }
/* 新闻内容 */
...
.hotNew .con .right .news .top{ font-size:0.12rem;  border-bottom: #eaeaea 1px solid; padding-bottom:0.05rem; line-height: 0.18rem; font-weight: bold; }
...
/* 标题栏 */
.index-box-t{ height:0.4rem; line-height:0.4rem; overflow:hidden; }
.good .index-box-t .left { display: inline-block; width: 64%; height: 0.3rem; margin-left: 0.1rem; border: 1px solid #000; border-radius: 3px; line-height: 0.3rem; text-align: center; font-size: 0;  }
.titleOne { display: inline-block; width: 37%; height: 0.3rem; line-height: 0.3rem; font-size: 0.14rem; font-weight: bold;  }
.titleTwo { display: inline-block; width: 62.8%; height: 0.3rem; line-height: 0.3rem; font-size: 0.14rem; color: #fff; background: #000;  }
.good .index-box-t .right { display: inline-block; width: 28%; height: 0.3rem; line-height: 0.3rem0; text-align: right; }
.newMore { display: inline-block; font-weight: bold; font-size: 9; font-size: 0.14rem; letter-spacing: 0.005rem; }
/* 天天特惠 */
