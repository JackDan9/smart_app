      ...
      <ul>
        ...
        <li>
          <router-link :to="{ path: '/notice/2'}">
            <div v-bind:class="[isRead2 ? 'ico red' : 'ico']">
        ...
        <li>
          <router-link :to="{ path: '/notice/3'}">
            <div v-bind:class="[isRead3 ? 'ico red' : 'ico']">
        ...
        <li>
          <router-link :to="{ path: '/notice/4'}">
            <div v-bind:class="[isRead4 ? 'ico red' : 'ico']">
              <img src="~@/assets/images/me4.png" alt />
            </div>
            <div class="txt">
...
.message-list li:last-child .txt {
  border: none;
}
.message-list li .txt .p1 {
  font-size: 0.16rem;
  color: #333333;
  margin-top: 0.03rem;
}
.message-list li .txt .p2 {
  font-size: 0.12rem;
  color: #666666;
  margin-top: 0.05rem;
}
.page-topnav .set {
  background: url("~@/assets/images/set.png") center center no-repeat;
