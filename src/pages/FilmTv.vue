<template>
    <div>
        ...
        <div class="tv-page">
                        ...
                        <template v-for="ad in video_ads">
                            <mt-swipe-item class="swipe-item">
                                <a v-on:click="changeClick(ad['id'],ad['url'])">
                                    <div class="swiper-slide"><img v-if="ad['picture']" :src="fullUrl(ad['picture'])+'!640.301'" class="w100"/></div>
                                </a>
                            </mt-swipe-item>
                        </template>
                    </mt-swipe>
                        ...
                        <template v-for="d_ad in d_video_ads">
                            <mt-swipe-item class="swipe-item">
                                <a v-on:click="changeClick(d_ad['id'],d_ad['url'])">
                                    <div class="swiper-slide"><img v-if="d_ad['picture']" :src="fullUrl(d_ad['picture'])+'!640.301'" class="w100"/></div>
                                </a>
                            </mt-swipe-item>
                        </template>
                    </mt-swipe>
            ...
            <div class="love">
                <div class="t">热剧推荐 <span>Hot!</span></div>
...
export default {
 ...
 methods: {
   ...
   changeClick:function(id,url){
    ...
    getData() {
     this.$http.get(this.videoUrl).then( (response) => {
...
.swipe {  height:1.7rem; color: #fff; font-size: 30px; text-align: center;}
.navTop span a{ display:inline-block; margin-left:0.05rem; margin-right:0.05rem; padding:0 0.1rem; font-size:0.16rem; color:#787878; }
.navTop span a.current{ color:#ffffff; border-bottom:#fff 2px solid}
.navTop .navCon { line-height: 0.38rem; }
.navTop .sea{ color: #fff;  }
...
.love .swiper-slide{ margin-top:0.1rem;color:#ffffff; overflow:hidden;float:left;width:30%;margin-left:2%;}
...
.love .swiper-slide{ margin-left:0;margin-right:0.1rem;}
.love .swiper-slide ul{ width:106%;}
.love .swiper-slide li{ width:30%; float:left; margin-right:2%;}
</style>
