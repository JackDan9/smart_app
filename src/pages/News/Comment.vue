              ...
              <li :key="index">
                ...
                <div class="info">
                  <div class="p1">
                    ...
                    >
                      <i
                        v-bind:class="[comment_data['isLike'] ? 'iconfont likedIcon' : 'iconfont noLikedIcon']"
                      >&#xe614;</i>
                      <p
                        v-bind:class="[comment_data['isLike'] ? 'likedCon' : 'noLikedCon']"
                      >{{comment_data['vote']}}</p>
                    </div>
                  </div>
                </div>
...
.mood-page .temp .p2 .img {
  width: 0.3rem;
  float: left;
}
.mood-page .temp .p2 .txt {
  float: left;
  font-size: 0.16rem;
  margin-left: 0.1rem;
  margin-top: 0.05rem;
...
.mood-page .digg .he1 {
  ...
  background: url("~@/assets/images/he1.png") center center no-repeat;
...
.mood-page .digg .he2 {
  ...
  -moz-border-radius: 0.35rem;
  border-radius: 0.35rem;
  background: url("~@/assets/images/he2.png") center center no-repeat;
  background-size: 0.15rem 0.15rem;
  border: #ededed 1px solid;
  margin-right: 0.1rem;
}
...
.mood-page .list li .info {
  margin-left: 0.6rem;
  overflow: hidden;
  font-size: 0.14rem;
}
.mood-page .list li .info .p1 {
  overflow: hidden;
  width: 100%;
  height: 0.5rem;
  margin-top: 0.05rem;
}
.mood-page .list li .info .p1 .name {
  font-size: 16px;
}
.mood-page .list li .info .p1 .time {
  font-size: 0.12rem;
  color: #a5a5a5;
}
.mood-page .list li .info .p1 .sup {
  width: 0.4rem;
  height: 0.4rem;
  float: right;
