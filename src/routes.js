...
import FunList from './pages/FunList.vue'
import Fun from './pages/Fun.vue'
import Service from './pages/Service.vue'
import Thing from './pages/Thing.vue'
import CharityList from './pages/CharityList.vue'
...
import CooperateHome from './pages/CooperateHome.vue'
...
import FunCat from './pages/FunCat.vue'
...
import FilmTv from './pages/FilmTv.vue'
